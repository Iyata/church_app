...
include_once 'model/church_activity.php'; #fetches activities for the view to display

include_once 'model/delete_activity.php'; #model script with delete function del_activity()
...
include_once'view/select_activity_del.phtml';